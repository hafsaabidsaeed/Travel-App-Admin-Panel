    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              'assets/mountain1.jpg', // Replace with your background image path
              fit: BoxFit.cover,
            ),
          ),
          Center(
            child: Container(
              ...
              child: Column(
                children: <Widget>[
                  // Logo image
                  Image.asset(
                    'assets/logo2.png', // Replace with your logo image path
                    height: 100,
                    width: 250,
                  ),
                  ...
                  TextButton(
                    ...
                    child: const Text.rich(
                      TextSpan(
                        ...
                        style: TextStyle(
                          color: Colors.white, // White text color for the main text
                          fontWeight: FontWeight.w700,
                          fontSize: 16,
                        ),
                        children: [
